    ...
    <div className="flex flex-col justify-center bg-white mb-8 p-4 w-[95%] mx-auto my-1 shadow-md text-base text-justify rounded-lg md:p-8 lg:text-lg">
      ...
      {internship.apply[0].status === "aceptado" && (
            <div className="text-red-500 bg-red-100 w-[100%] text-justify">
             <p className="p-2"> 🎉¡Felicidades! has sido aceptado en esta oferta. Dirgite a la  
              <b> Dirección de Educación y Asuntos Universitarios de la Alcaldía</b>, para retirar el  
              <b> Oficio de tu Postulación</b> que debes llevar a <b>{internship.dependencia.name}, 
                </b> y así comenzar tu proceso de {internship.type === "pasantia"
                  ? "Pasantias"
                  : internship.type === "servicio"
                  ? "Servicio Cominitario"
                  : ""}, cuyo lapso ha comenzado🎉</p>
            </div>
          )}
