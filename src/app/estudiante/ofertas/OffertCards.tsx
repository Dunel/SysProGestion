...
export default function InternshipCards({
  ...
  const InternshipCard: React.FC<{ internship: Internship }> = ({
    ...
    <div className="bg-white flex flex-col justify-center bg-white mb-8 p-4 w-[95%] mx-auto my-1 shadow-md text-base text-justify rounded-lg md:p-8 lg:text-lg">
  ...
  return (
    <>
      <div className="flex-col justify-center items-center relative z-20 py-2 mx-auto rounded shadow w-[98%]">
