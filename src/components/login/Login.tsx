              ...
              {errors.email ? (
                <>
                  ...
                  <span className="text-gray-500 text-xs">
                    El correo debe ser válido y tener entre 10 y 75 caracteres.
                  </span>
                </>
              ) : (
                <span className="text-gray-500 text-xs">
            ...
            <LabelInputContainer className="mb-4">
              ...
              {errors.password ? (
                <>
                  ...
                  <span className="text-gray-500 text-xs">
                    La contraseña debe tener entre 8 y 26 caracteres, incluyendo
              ...
              {errorLog && <p className={`text-red-500 text-sm`}>{errorLog}</p>}
            </LabelInputContainer>
