  ...
  return (
    <>
                ...
                {editingId === registro.id ? (
                  ...
                  <>
                    ...
                    <Button
                      ...
                      size="icon"
                      onClick={() =>
                        registro.id ? confirmDelete(registro.id) : null
                      }
                    >
      ...
      <Modal
        ...
        onConfirm={() => registroToDelete && handleBorrar(registroToDelete)}
        title="Confirmar eliminación"
        message={`¿Está seguro de que desea eliminar el preregistro con ID ${registroToDelete}?`}
      />
    </>
  );
}